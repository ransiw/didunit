...
aggite_table <- function(AGGITE){
  ...
  if (is.null(AGGITE$crit.val.egt)){
    results = data.frame(egt=AGGITE$egt,att.egt=AGGITE$att.egt,lci.egt=AGGITE$lci.egt,uci.egt=AGGITE$uci.egt)
  } else {
    results = data.frame(egt=AGGITE$egt,att.egt=AGGITE$att.egt,se.egt=AGGITE$se.egt)
  ...
  if (!is.null(AGGITE$egt2)){
    results = data.frame(egt=AGGITE$egt,egt2=AGGITE$egt2,att.egt=AGGITE$att.egt,lci.egt=AGGITE$lci.egt,uci.egt=AGGITE$uci.egt)
  }
